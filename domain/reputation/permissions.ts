...
const ACTIONS = {
  ...
  add_organisation: Rank.Eloquent,
  add_membership: Rank.Eloquent,
  ...
  edit_organisation: Rank.Idealiste,
  remove_membership: Rank.Idealiste,
...
const REWARDS = {
  ...
  added_organisation_validated: 50,
  added_membership: 5,
  edited_subject: 5,
  edited_statement: 5,
  edited_personality: 5,
  edited_organisation: 5,
  edited_position: 5,
