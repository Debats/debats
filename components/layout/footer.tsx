...
import { siteDescription } from '../../app/site'
...
const socialLinks = [
  ...
  {
    href: 'https://discord.gg/EsrUszeZYn',
    label: 'Discord',
...
export default async function Footer() {
  ...
  const projectLinks: FooterLink[] = [
    ...
    ...(admin ? [{ href: '/admin/drafts', label: 'Brouillons' }] : []),
  ]
      ...
      <div className={styles.container}>
        <div className={styles.brandBlock}>
          <Link href="/" className={styles.brand}>
            <Image src="/images/logo-mark.png" alt="" width={27} height={26} />
            <span className={styles.wordmark}>Débats</span>
          </Link>
          <p className={styles.tagline}>{siteDescription}</p>
        ...
        <nav className={styles.columns} aria-label="Pied de page">
          ...
          />
          <FooterColumn title="Projet" links={projectLinks} />
        </nav>
      </div>
    </footer>
  )
