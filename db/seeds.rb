...
preuve = kahn_mort_naturelle.evidences.build(fact_date: 5.days.ago, evidence_date: 5.days.ago, title: "TF1 20h", url: "http://www.tf1.fr")
kahn_mort_naturelle.save
preuve.save

mec_pour = pour.statements.build(            public_figure: mec)
preuve = mec_pour.evidences.build(fact_date: 5.days.ago, evidence_date: 5.days.ago, title: "TF1 20h", url: "http://www.tf1.fr")
mec_pour.save
preuve.save

autre_suicide_assiste = suicide_assiste.statements.build( public_figure: autre)
preuve = autre_suicide_assiste.evidences.build(fact_date: 5.days.ago, evidence_date: 5.days.ago, title: "TF1 20h", url: "http://www.tf1.fr")
autre_suicide_assiste.save
preuve.save

valls_droit_nouveau = droit_nouveau.statements.build(   public_figure: valls)
preuve = valls_droit_nouveau.evidences.build(fact_date: 5.days.ago, evidence_date: 5.days.ago, title: "TF1 20h", url: "http://www.tf1.fr")
valls_droit_nouveau.save
preuve.save

segolene_droit_nouveau = droit_nouveau.statements.build(   public_figure: segolene)
preuve = segolene_droit_nouveau.evidences.build(fact_date: 5.days.ago, evidence_date: 5.days.ago, title: "TF1 20h", url: "http://www.tf1.fr")
segolene_droit_nouveau.save
preuve.save

hollande_droit_nouveau = droit_nouveau.statements.build(   public_figure: hollande)
preuve = hollande_droit_nouveau.evidences.build(fact_date: 5.days.ago, evidence_date: 5.days.ago, title: "TF1 20h", url: "http://www.tf1.fr")
hollande_droit_nouveau.save
preuve.save

toto_leonetti = leonetti.statements.build(        public_figure: toto)
preuve = toto_leonetti.evidences.build(fact_date: 5.days.ago, evidence_date: 5.days.ago, title: "TF1 20h", url: "http://www.tf1.fr")
toto_leonetti.save
preuve.save
