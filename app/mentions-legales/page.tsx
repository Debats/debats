    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          Le site debats.co est un projet collaboratif bénévole.
        </p>
        <p className={styles.text}>
          Directeur de la publication : Jalil Arfaoui
        </p>
        <p className={styles.text}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          Le <a href="https://forge.tiqa.fr/debats/debats" target="_blank" rel="noopener noreferrer">code source</a> de Débats.co est disponible sous licence MIT.
          Le contenu éditorial est sous licence Creative Commons BY-SA 4.0.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.text}>
          ...
          Les données éventuellement recueillies dans le cadre de la création
          d&apos;un compte utilisateur sont utilisées uniquement pour le
        ...
        <p className={styles.text}>
          ...
          à <a href="mailto:contact@debats.co">contact@debats.co</a>.
        </p>
      </section>
    </div>
  )
